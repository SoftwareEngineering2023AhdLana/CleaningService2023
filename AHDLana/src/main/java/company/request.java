...
public request(String date , String t, int s,product p1) {
	this.date= date;
	this.status=s;
	this.time=t;
	p=p1;
...
{
	return this.p.getName()+"  Price: "+this.p.getPrice()+" NIS"+" Date: "+date + "  Time: " + time + "  Status: "+(status==1?"Done":"Still")+"  Service: "
			;
}
